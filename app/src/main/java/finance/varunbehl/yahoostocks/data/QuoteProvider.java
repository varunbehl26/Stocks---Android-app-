...
public class QuoteProvider {
    public static final String AUTHORITY = "finance.varunbehl.yahoostocks.data.QuoteProvider";
    ...
    public static ContentProviderOperation buildBatchOperation(GetHistoricalData.Quote quote) {
